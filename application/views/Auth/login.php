                        ...
                        <div class="col-sm-12 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <div class="d-flex align-items-center w-auto">
                                    <img src="<?=base_url();?>assets/img/main.png" alt="" width="50px">
                                    <h1 class="d-lg-block font-primary fw-500">GANDL</span>
                                </div>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation"
                                        action="<?=base_url();?>Auth/login_validation" method="post">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="username" class="form-control"
                                                    id="yourUsername" value="<?=set_value('username')?>" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="password" class="form-control"
                                                id="yourPassword" value="<?=set_value('password')?>" required>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Don't have account? <a
                                                    href="<?=base_url();?>Auth/register">Create an account</a></p>
                                        </div>
                                    </form>
